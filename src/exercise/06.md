...
- `htmlFor` is really useful for screenreaders. When you click on the username,
  the focus will move to its input!
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=06%3A%20Forms&em=kelly.ma%40mail.mcgill.ca).
